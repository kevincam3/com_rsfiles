...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        jQuery('#com-rsfiles-upload-field').on('change', function (e) {
            upload_files = true;
        });
...
<div class="rsfiles-layout">
                    ...
                    <ul class="nav rsf_navbar_ul">
                        ...
                        <li>
                            <a class="btn <?php echo rsfilesHelper::tooltipClass(); ?>"
                               ...
                               href="<?php echo JRoute::_('index.php?option=com_rsfiles' . ($this->briefcase ? '&layout=briefcase' : '') . ($this->folder ? '&folder=' . rsfilesHelper::encode($this->folder) : '') . $this->itemid); ?>">
    ...
    <form action="<?php echo JRoute::_('index.php?option=com_rsfiles'); ?>" method="post" name="adminForm"
          id="rsfl_upload_form" enctype="multipart/form-data">
            ...
            <div class="well">
                <div class="rsfiles-upload-box">
                    <div class="rsfiles-upload-box-top">
                        ...
                        <div id="com-rsfiles-progress" class="com-rsfiles-progress" style="display:none;">
                            <div style="width: 1%;" id="com-rsfiles-bar" class="com-rsfiles-bar">0%</div>
                        </div>
                    </div>
                    ...
                    <label for="com-rsfiles-upload-field" class="rsfiles-upload-box-label">
                        ...
                        <span id="com-rsfiles-add-files">
							<span id="com-rsfiles-simple-add-files"
                                  style="display:none;"><?php echo JText::_('COM_RSFILES_ADD_FILES'); ?></span>
							<span id="com-rsfiles-drag-add-files"
                                  style="display:none;"><?php echo JText::_('COM_RSFILES_ADD_DRAG_FILES'); ?></span>
						</span>
                        <span id="com-rsfiles-no-files"
                              style="display: none;"><?php echo JText::_('COM_RSFILES_READY_FOR_UPLOAD', true); ?></span>
                    </label>
                    <input id="com-rsfiles-upload-field" name="file" type="file" class="input-large" size="20"
					       <?php if (!$this->single) { ?>multiple<?php } ?> />

                    <div class="rsfiles-upload-box-bottom">
                        <label for="overwrite" class="btn" id="rsf_overwrite">
                            <input type="checkbox" name="overwrite" id="overwrite" value="1"/> <span
                                    class="rsf_inline"><?php echo JText::_('COM_RSFILES_OVERWRITE'); ?></span>
                        </label>
